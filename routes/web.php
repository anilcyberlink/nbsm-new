...
Route::middleware(['auth'])->group(function () {
    ...
    // For post
    route::get('admin/{uri}/show-in-home-list', 'AdminControllers\Posts\PostController@showInHomeList')->name('admin.resource.home.list');
    ...
    Route::put('post-show-in-home/{id}', 'AdminControllers\Posts\PostController@postShowInHome')->name('admin.post.home');
