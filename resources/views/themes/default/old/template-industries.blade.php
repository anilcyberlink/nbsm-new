        ...
        <div class="uk-home-banner uk-width-1-1 uk-position-z-index">
            <div class="uk-container uk-container-large uk-position-relative  uk-flex-middle uk-flex"
                ...
                <div class="uk-width-1-2@l uk-width-1-1"
                    ...
                    <h1 class="uk-text-bold uk-h4 text-white uk-margin-remove"><a href="{{ url('page/' . posttype_url($pos_type->uri)) }}">{{$pos_type->post_type}}</a></h1>
            ...
            <div class="uk-grid-large" uk-grid>
                ...
                <div class="uk-width-1-3@s">
                    <div style="z-index: 9;" uk-sticky="media: @m;  offset: 150; bottom: #uk-stop-sticky;">
                        <div class="uk-margin">
                            <a href="{{route('proposal-request',$data->uri)}}" class="uk-button uk-button-secondary uk-width-1-1">Request
                                for Proposal</a>
                        </div>
