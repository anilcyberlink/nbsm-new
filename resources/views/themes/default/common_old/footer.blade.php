<section class="uk-section bg-light uk-text-center"
    ...
    <div class="uk-container uk-container-xsmall"
        ...
        <div class="ug-grid" uk-grid>
            ...
            <div class="uk-width-1-2@s">
                <a href="{{ route('proposal-request') }}" class="uk-button uk-button-primary-dark uk-width-1-1">Request
                    For Proposal</a>
            </div>
        ...
        <div class="uk-container uk-container-large">
            ...
            <div class="uk-grid-large uk-margin-remove-bottom uk-flex-middle" uk-grid>
                ...
                <div class="uk-width-auto@m">
                    ...
                    <a href="https://www.moore-global.com/" target="_blank"><img
                            src="{{ asset(env('PUBLIC_PATH')) }}/images/moore.png" alt="Moree"></a>
                </div>
            </div>
            <!--  -->
        </div>
            ...
            <div class="uk-margin-remove-bottom tm-grid-expand uk-grid-large uk-margin-xlarge uk-grid" uk-grid=""
                ...
                <div class="uk-width-1-2@s  uk-width-1-2  uk-width-expand@m">
                    <ul class="uk-list-varticle">
                        @if ($navigations->count())
                            @foreach ($navigations as $row)
                                @if ($loop->iteration == 2)
                                    <li><a href="{{ url('page/' . posttype_url($row->uri)) }}"><span
                                                class="uk-margin-small-right text-secondary"
                ...
                <div class="uk-width-1-3@s">
                    <ul class="uk-list-varticle">
                        ...
                        <li class=" uk-flex"><i class="fa fa-phone uk-margin-small-right uk-text-large"></i>
                            {{ $setting->phone }}</li>
                        <li class=" uk-flex"><i class="fa fa-envelope uk-margin-small-right uk-text-large"></i>
            ...
            <div class="uk-grid-small uk-flex uk-flex-between uk-flex-middle " uk-grid>
                ...
                <div>
                    <a href="https://www.accaglobal.com/gb/en.html" target="_blank"
                        uk-tooltip="title: Trainee Development - Gold">
