    ...
    <header uk-sticky="top:600; animation: uk-animation-slide-top  uk-animation-slow uk-transform-origin-bottom-center">
                                        ...
                                        @foreach ($navigations as $row)
                                            @if ($loop->iteration == 1)
                                                <li>
                                                    ...
                                                    <div class="uk-navbar-dropdown uk-mega-menu uk-margin-remove uk-padding-remove uk-border-top"
                                                        ...
                                                        <div class="uk-container">
                                                            <!--  -->
                                                            <div class="uk-grid  uk-grid-divider uk-margin-medium uk-child-width-1-3@s uk-mega-list"
                                                                uk-grid
                                                                                    ...
                                                                                    <li>
                                                                                        @if ($_row->external_link)
                                                                                            <a href="{{ $_row->external_link }}"
                                                                                                title=""
                                                                                                target="_blank">{{ \Illuminate\Support\Str::ucfirst($_row->post_title) }}</a>
                                                                                        @else
        ...
        @if ($navigations->count())
            @foreach ($navigations as $row)
                @if ($loop->iteration == 2)
                    <li>
                        <a href="{{ url('page/' . posttype_url($row->uri)) }}" title="">{{ $row->post_type }}
                        ...
                        <div class="uk-navbar-dropdown uk-mega-menu uk-margin-remove uk-padding-remove uk-border-top"
                            ...
                            <div class="uk-container">
                                <!--  -->
                                <div class="uk-grid  uk-grid-divider uk-margin-medium uk-child-width-1-4@s uk-mega-list"
                                    uk-grid
                                    uk-scrollspy="cls: uk-animation-slide-top-small; delay: 300; repeat: false;">
                                    <!--  -->
                                    @if (has_posts($row->id))
                                            ...
                                            <div>
                                                <div class="uk-padding-menu">
                                                    <h5 class="uk-text-bold uk-margin-small">
                                                        @if ($_row->external_link)
                                                            <a href="{{ $_row->external_link }}" title=""
                                                                class="text-white"
                                                                target="_blank">{{ $_row->post_title }}</a>
                                                        @else
                                                            <a href="{{ url(geturl($_row->uri)) }}" title=""
                                                                class="text-white">{{ $_row->post_title }}</a>
                                                        @endif
                                                    </h5>
                                                    <ul class="uk-list  uk-margin-remove">
        ...
        @if ($navigations->count())
            @foreach ($navigations as $row)
                @if ($loop->iteration == 5)
                    <li>
                        <a href="{{ url('page/' . posttype_url($row->uri)) }}"
                            title="">{{ $row->post_type }}<span class="uk-margin-xsmall-left"
            ...
            <div class="uk-offcanvas-bar uk-padding-remove">
                ...
                <nav class="uk-card-body">
                    <ul class="uk-iconnav uk-flex-center">
                        <li><a class="instagramBtn smGlobalBtn" href="{{ $setting->instagram_link }}"
                                target="_blank"></a></li>
                        <li><a class="facebookBtn smGlobalBtn" href="{{ $setting->facebook_link }}"
                                target="_blank"></a></li>
                        <li><a class="twitterBtn smGlobalBtn" href="{{ $setting->twitter_link }}"
                                target="_blank"></a></li>
                        <li> <a class="linkedinBtn smGlobalBtn" href="{{ $setting->linkedin_link }}"
                                target="_blank"></a></li>
                    </ul>
                </nav>
            </div>
