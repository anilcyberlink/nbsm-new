...
@section('title', 'Associated Posts')

@section('breadcrumb')

    @if (Request::segment(3))
        <a href="{{ route('admin.post.index', Request::segment(3)) }}" class="btn btn-default btn-sm">
            <i class="fa fa-angle-double-left"></i> Back
        </a>
    @endif

    <a href="{{ url('admin/associated/' . Request::segment(3) . '/' . Request::segment(4) . '/create') }}"
                                        ...
                                        <td class="post_title title_hi_sh">
                                            ...
                                            <div class="row_actions">
                                                ...
                                                <span class="edit">
                                                    ...
                                                    <a
                                                        href="{{ url('admin/associated/' . Request::segment(3) . '/' . $row->id . '/edit') }}">
                                                        Edit
                                                    </a>
