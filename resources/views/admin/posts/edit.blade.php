        ...
        <div class="sid_ mb10">
          <h4> File </h4>
            ...
            <div id="xedit-demo"> 
              ...
              <a href="{{ asset(env('PUBLIC_PATH').'uploads/large/' . $data->icon) }}" target="_blank"><img src="{{ asset(env('PUBLIC_PATH').'images/download-icon.png') }}" width="50" /></a>
          ...
          <h4> Featured Image </h4>
            ...
            <div id="xedit-demo"> 
              ...
              <a href="#{{$data->id}}" class="delete_pagethumbnail">X</a>
               <a href="{{ asset(env('PUBLIC_PATH').'uploads/medium/' . $data->page_thumbnail) }}" target="_blank"><img src="{{ asset(env('PUBLIC_PATH').'uploads/medium/' . $data->page_thumbnail) }}" width="150" /></a>
              <hr>
              </span>
              @endif                       
        ...
        <div class="sid_ mb10">
          <h4> Banner </h4>
            ...
            <div id="xedit-demo"> 
             ...
             <a href="{{ asset(env('PUBLIC_PATH').'uploads/medium/' . $data->banner) }}" target="_blank"> <img src="{{ asset(env('PUBLIC_PATH').'uploads/medium/' . $data->banner) }}" width="150" /></a>
              <hr>
              </span>
              @endif                       
