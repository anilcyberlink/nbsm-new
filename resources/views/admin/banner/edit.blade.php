...
<div class="col-md-12">
            ...
            <div class="panel">
              ...
              <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label class="col-lg-3 control-label" for="videolink">Youtube Video Link</label>
                    <div class="col-lg-6">
                      <div class="bs-component">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <div class="bs-component">
                          <a href="#{{$data->id}}" class="banner_delete">X</a>
                 ...
                 <div class="form-group">
                    <label class="col-lg-3 control-label" for="link">Banner Link</label>
                    <div class="col-lg-6">
                      <div class="bs-component">
